    ...
    <div class="card-body">
      ...
      <form action="{{ route('part.update', $parts->id) }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="part_name" name="part_name" value="{{ $parts->part_name }}" required>
        </div>

        <div class="mb-3">
          <label for="part_number" class="form-label">Part Number</label>
          <input type="text" class="form-control" id="part_number" name="part_number" value="{{ $parts->part_number }}" required>
        </div>
